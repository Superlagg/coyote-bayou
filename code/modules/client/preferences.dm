...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if(APPEARANCE_TAB)
			...
			dat += "<b>Runechat Font:</b><a style='display:block;width:100px' href='?_src_=prefs;preference=chat_font;task=input'>[features["chat_font"]]</span></a><BR>"
...
*/
				...
				if("chat_font")
					var/result = input(user, "Select a Font for your Runechat (default is Veranda)", "Font Selection") as null|anything in GLOB.cool_fonts
					if(result)
						features["chat_font"] = result
